...
module.exports.init = function () {
  if (f.isRepo() && f.exists(path.join(process.cwd(), '.ideablock')) && f.exists(path.join(process.cwd(), '.git', 'hooks', 'post-commit'))) {
    ...
    log('\n\t❗ ' + chalk.bold.black('The present directory is not a git repository.'))
